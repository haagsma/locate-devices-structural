...
! function($) {
    ...
    GoogleChart.prototype.init = function () {
        ...
        //creating line chart
        var common_data = [
            ['Meses', 'Usuarios', 'Estabelecimentos'],
            ['Jan',  1000,      400],
            ['Fev',  1170,      460],
            ['Mar',  660,       2120],
            ['Abr',  1030,      540],
        ...
        $this.createLineChart($('#line-chart')[0], common_data, 'Usuarios e Estabelecimentos', ['#348cd4', '#45bbe0']);
        ...
        $this.createColumnChart($('#column-chart')[0], column_data, 'Usuarios e Estabelcimentos', ['#348cd4', '#45bbe0', '#8892d6']);


        //creating bar chart
        var bar_data = [
            ['Meses', 'IOS', 'Android', 'Site'],
            ['Jan',  1000,      400,    250],
            ['Fev',  1170,      460,    290],
            ['Mar',  660,       1120,   350],
            ['Abr',  1030,      540,    420],
        ...
        $(window).on('resize', function() {
            $this.createLineChart($('#line-chart')[0], common_data, 'Usuarios e Estabelecimentos', ['#4bd396', '#f5707a']);
